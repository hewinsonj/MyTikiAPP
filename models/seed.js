...
db.on('open', (req, res) => {
    const startDrinks = [
        ...
        prepInstructs: ["Add ingredients to shaker tin", "shake until dilluted", "dirty dump", "top with fresh pebble ice", "place pineapple wedge on side of glass", "add straw and serve!"],
        fav: true
        },
        { name: "Grog",
        ogCreator: "Donn Beach",
        ...
        glassware: "Muffintop",
        prepInstructs: ["Add all ingredients (except soda) to shaker tin", "shake 7 times", "pour over fresh ice", "top with soda", "lay lime wheel on top", "char one end of cinnamon stick and place on top of lime wheel and serve!"],
        },
        ...
        prepInstructs: ["Add ingredients to shaker tin (except ginger beer)", "shake hard 7 times", "strain over fresh ice", "top with ginger beer", "smack mint and nestle on top", "add straw and serve!"],
        },
        { name: "Zombie",
        ogCreator: "Donn Beach",
        ...
        prepInstructs: ["Add ingredients to shaker tin", "shake until dilluted", "dirty dump", "top with fresh pebble ice", "place pineapple wedge on side of glass", "nestle mint sprig next to pineapple wedge", "add straw and serve!"],
        fav: true
        }
      ]
