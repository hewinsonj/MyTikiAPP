...
db.on('open', () => {
    const startDrinks = [
        ...
        { name: "Zombie",
        ogCreator: "Donn Beach",
        ingredient: ["Don q 7 year", ".5oz", "Appleton Estate Signature", ".5oz", "Lemonhart 151", ".5oz", "Bounty White", "1oz", "Velvet Falernum", ".25oz", "Lime Juice", ".75oz", "Grenadine", "Don's Mix #5", ".5oz", "Angostura Bitters", "2 dashes", "Herbsaint Liquor", "2 sprits"],
